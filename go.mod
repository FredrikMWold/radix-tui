...
require (
	...
	github.com/equinor/radix-cli v1.33.4
...
require (
	...
	github.com/equinor/radix-common v1.11.0 // indirect
	github.com/equinor/radix-operator v1.87.0 // indirect
...
// no local replace; using published radix-cli module version
